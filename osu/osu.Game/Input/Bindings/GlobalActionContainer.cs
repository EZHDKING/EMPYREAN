...
namespace osu.Game.Input.Bindings
{
    public partial class GlobalActionContainer : DatabasedKeyBindingContainer<GlobalAction>, IHandleGlobalKeyboardInput, IKeyBindingHandler<GlobalAction>
    {
        ...
        private static IEnumerable<KeyBinding> globalKeyBindings => new[]
        {
            ...
            // EMPYREAN: backtick/tilde opens the DOS console (PROJECT.md §6).
            new KeyBinding(InputKey.Tilde, GlobalAction.ToggleEmpyreanTerminal),
        };
    ...
    public enum GlobalAction
    {
        ...
        // EMPYREAN: appended at the end of the enum so existing persisted keybinding indices are unaffected.
        [LocalisableDescription(typeof(GlobalActionKeyBindingStrings), nameof(GlobalActionKeyBindingStrings.ToggleEmpyreanTerminal))]
        ToggleEmpyreanTerminal
    }
