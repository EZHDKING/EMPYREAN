...
namespace osu.Game.Screens.Menu
{
    public abstract partial class IntroScreen : StartupScreen
    {
        ...
        /// <summary>
        /// EMPYREAN: true once the next screen (the main menu) has finished async-loading and
        /// can be safely pushed. Used by <see cref="IntroNone"/> for the fastest safe boot.
        /// </summary>
        protected bool NextScreenReady => nextScreen == null || nextScreen.LoadState == LoadState.Ready || nextScreen.LoadState == LoadState.Loaded;
    }
}
