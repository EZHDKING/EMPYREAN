...
namespace osu.Game.Localisation
{
    public static class GlobalActionKeyBindingStrings
    {
        ...
        /// <summary>
        /// "Toggle EMPYREAN terminal"
        /// </summary>
        public static LocalisableString ToggleEmpyreanTerminal => new TranslatableString(getKey(@"toggle_empyrean_terminal"), @"Toggle EMPYREAN terminal");
