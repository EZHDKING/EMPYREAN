...
namespace osu.Game.Overlays.Toolbar
{
    public partial class Toolbar : OverlayContainer, IKeyBindingHandler<GlobalAction>
    {
        ...
        {
            // EMPYREAN: the modern top toolbar is removed in favour of the Win95 bottom taskbar.
            // Keep it permanently hidden and off-screen so nothing in it shows or catches input.
            this.MoveToY(-DrawSize.Y);
            Alpha = 0;
        }
