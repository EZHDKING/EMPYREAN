...
namespace osu.Game.Overlays
{
    public abstract partial class WizardScreen : Screen
    {
        ...
        private void load()
        {
            ...
            // EMPYREAN: the Win95 installer body is white, so default all child text/icons to
            // black for readability (individual controls can still override their own colour).
                    ...
                    Child = new Container
                    {
                        ...
                        Children = new Drawable[]
                        {
                            new OsuSpriteText
                            {
                                ...
                                // EMPYREAN: dark text on the white Win95 installer body.
                                Colour = osuTK.Graphics.Color4.Black,
                            },
