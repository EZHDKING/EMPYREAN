...
{
    // Added IApplicableToDifficulty here 👇
    public partial class OsuModFlashlight : ModFlashlight<OsuHitObject>, IApplicableToDrawableHitObject, IApplicableToDifficulty
    {
        public override bool Ranked => true;

        // Force Circle Size to 0 here 👇
        public void ApplyToDifficulty(BeatmapDifficulty difficulty)
        {
            difficulty.CircleSize = -200;
        }
