...
namespace osu.Framework.Allocation
{
    ...
    public class CachedAttribute : Attribute
    {
        ...
        internal static CacheDependencyDelegate CreateActivator(Type type)
        {
            ...
            {
                if (!hasCachedAttribute(property))
                    continue;
        ...
        private static bool hasCachedAttribute(MemberInfo member)
        {
            foreach (var _ in member.GetCustomAttributes<CachedAttribute>())
                return true;
