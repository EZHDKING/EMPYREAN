...
namespace osu.Framework.Threading
{
    ...
    {
        // EMPYREAN: the active thread rate ceiling. Upstream is 10000; raised to int.MaxValue so the
        // update/draw threads are not artificially capped. Actual rate is then bounded only by how
        // fast the CPU/GPU can complete frames. Inactive stays low to avoid wasting cycles when the
        // window is unfocused.
        internal const int DEFAULT_ACTIVE_HZ = int.MaxValue;
